          ...
          <CardContent sx={{ p: 3, position: 'relative' }}>
            ...
            <Box sx={{ borderLeft: `2px solid ${GOLD}66`, pl: 1.75 }}>
              <Typography sx={{ color: '#E2E8F0', fontSize: 14.5, lineHeight: 1.7, mb: 1 }}>
                Привет, {data.name}. Меня зовут Михаил Клименков, я генеральный директор и сооснователь цифровой платформы Welcome 24.
              </Typography>
              <Typography sx={{ color: '#CBD5E1', fontSize: 14, lineHeight: 1.7 }}>
                У нас самый высокий процент в стране, каждый агент — акционер компании и строит свой пассивный доход. Команда, обучение и партнёры по всей стране — всё в одном портале. Идём к цели в 10 000 агентов и хотим стать крупнейшей компанией для риелторов в России. Рад, что ты с нами — пройди первые шаги ниже, чтобы освоиться быстрее.
              </Typography>
            </Box>
          </CardContent>
        </Card>
